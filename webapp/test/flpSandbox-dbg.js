		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Envio de industrialização",
									"targetURL": "#Enviodeindustrializacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Enviodeindustrializacao-display": {
								"semanticObject": "Enviodeindustrializacao",
								"action": "display",
								"description": "Envio de industrialização",
								"title": "Envio de industrialização",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.arcelor.zbmmm0009",
									"url": sap.ui.require.toUrl("br/com/arcelor/zbmmm0009")
								}
							}
						}
					}

sap.ui.define([
	...
	return Opa5.extend("br.com.arcelor.zbmmm0009.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["br/com/arcelor/zbmmm0009/localService/mockserver"], function (mockserver) {

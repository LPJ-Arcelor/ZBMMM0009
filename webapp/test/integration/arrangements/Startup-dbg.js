sap.ui.define([
	"sap/ui/test/Opa5",
	"br/com/arcelor/zbmmm0009/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("br.com.arcelor.zbmmm0009.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "RelIndustSet/" + sObjectId;
